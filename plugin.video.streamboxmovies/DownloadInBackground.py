...
global DeleteIncomplete, DownloadComplete 
...
def Notification(currentPercent):
    ...
    if currentPercent in NotifyPercents:
        ...
        try:
            del NotifyPercents[NotifyPercents.index(currentPercent)]
        except: 
        ...
        xbmc.executebuiltin( "XBMC.Notification(%s,%s,%i)" % ( 'Download Progress - ' + str(currentPercent)+'%', uq_file, 5000))
...
try: 
    ...
    #print "ERROR WHILST DOWNLOADING"
