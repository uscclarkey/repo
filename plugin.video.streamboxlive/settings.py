...
import os
#testing HLS setting
ADDON = xbmcaddon.Addon(id='plugin.video.streamboxlive')
DATA_PATH = os.path.join(xbmc.translatePath('special://profile/addon_data/plugin.video.streamboxlive'), '')
FTV_PATH = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.streamboxlive', ''))
