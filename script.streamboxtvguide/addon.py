...
ADDON       = xbmcaddon.Addon(id = 'script.streamboxtvguide')
HOME        = ADDON.getAddonInfo('path')
TITLE       = 'StreamBox TV Guide'
VERSION     = '1.0.0'
...
print '****** STREAMBOX TV GUIDE INFORMATION ******'
...
def CheckVersion():
    ...
    if prev == '1.0.0':
        d = xbmcgui.Dialog()
        d.ok(TITLE + ' - ' + VERSION, 'For updates, channel status and support...' , '[COLOR FF00FF00]www.streamboxlive.wordpress.com[/COLOR]',  'Thank you for using StreamBox TV Guide, Enjoy.')
...
buggalo.GMAIL_RECIPIENT = 'streamboxlive89@gmail.com'
