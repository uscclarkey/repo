...
def CheckIdle(maxIdle):
    ...
    dp.create("StreamBox TV Guide","Streaming will automatically quit in %d seconds" % count, "Press Cancel to contine viewing")
    dp.update(0)
...
def checkForAlternateStreaming(url):
    ...
    # if 'plugin.video.streamboxlive' in url:
    #     print '****** Alternate  StreamBox Live ******'
    #     print url
    #     return alternateStream(url)
